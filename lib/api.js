...
import { localData } from "../data/games.js";

import { useRouter } from "next/router";

export const useBasePath = () => useRouter().basePath;
...
export async function getGames() {
  ...
  games.map((game) => {
    ...
    game["category"] = toFormat(game.category);
    game[
      "icon"
    ] = `https://cdn.iwantalipstick.com/gameicon2/webp/${game.name}.webp`;
  });
