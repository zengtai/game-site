  ...
  if (games.length != 0) {
    if (title === undefined) {
      return (
        <>
          <ul
            className={`grid ${setCol()} gap-3 px-4 py-3 sm:grid-cols-4 md:grid-cols-6 md:gap-6 md:px-12 lg:grid-cols-8 2xl:grid-cols-11`}
          >
            <GameListItem
              games={games}
              className={className}
      ...
      return (
        <>
          ...
          <ul
            className={`grid ${setCol()} gap-3 py-3 px-4 sm:grid-cols-4 md:grid-cols-6 md:gap-6 md:px-12 lg:grid-cols-8 2xl:grid-cols-11`}
          >
            <GameListItem
              games={games}
              className={className}
